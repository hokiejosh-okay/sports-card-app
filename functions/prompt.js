...
- flags: set each boolean true only with on-card evidence — rookie (an RC logo or clearly a rookie card), auto (an on-card or sticker autograph), relic (a jersey/patch/memorabilia swatch — relic covers all memorabilia), patch (a multi-color patch swatch specifically), shortPrint (an SP/SSP marking).
